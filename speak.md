...
An **`ecosystem`** is a group of living and **`non-living`** things that live together and **`depend`** on each other to stay healthy. A famous example of this **`balance`** happened in Yellowstone Park. In the early 1900s, people **`killed`** all the **`wolves`** in the park, and by 1926, they were **`completely`** gone.
